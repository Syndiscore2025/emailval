...
```json
{
  ...
  "summary": { "total": 100, "clean": 82, "catchall": 6, "invalid": 10, "disposable": 2 },
  "results": {
    "clean": [
      { "record_id": "rec_001", "email": "alice@acme.com", "valid": true, "checks": { "smtp": true } }
    ],
    "invalid": [
      { "record_id": "rec_042", "email": "bad@nowhere.xyz", "valid": false, "errors": ["domain_not_found"] }
    ],
    "catchall": [ ... ],
    "disposable": [ ... ]
  },
...
- [ ] Upload a batch of 5 emails and get a `202` with `upload_id`
